package com.FMSS.kolayik.exception;
import com.FMSS.kolayik.model.ExceptionModel;
...
public class GeneralExceptionAdviser extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> baseExceptionHandler(BaseException exception){
        ExceptionModel exceptionModel = new ExceptionModel(HttpStatus.BAD_REQUEST, exception.getMessage());
